...
>[] = [
  ...
  },
  {
    ...
    description: "Target €15,000 minimum for relocation buffer",
    completed: false,
    due_date: "2026-08-01",
    priority: "medium",
  },
...
export function createDemoData(): AppData {
  ...
  const snapshots: NetWorthSnapshot[] = [
    { id: generateId(), user_id: DEMO_USER_ID, snapshot_date: "2025-12-01", total_assets: 72000, total_liabilities: 15000, net_worth: 57000, currency: "EUR", created_at: ts },
    { id: generateId(), user_id: DEMO_USER_ID, snapshot_date: "2026-01-01", total_assets: 74500, total_liabilities: 14500, net_worth: 60000, currency: "EUR", created_at: ts },
    { id: generateId(), user_id: DEMO_USER_ID, snapshot_date: "2026-02-01", total_assets: 76800, total_liabilities: 14000, net_worth: 62800, currency: "EUR", created_at: ts },
    { id: generateId(), user_id: DEMO_USER_ID, snapshot_date: "2026-03-01", total_assets: 79200, total_liabilities: 13500, net_worth: 65700, currency: "EUR", created_at: ts },
    { id: generateId(), user_id: DEMO_USER_ID, snapshot_date: "2026-04-01", total_assets: 81500, total_liabilities: 13000, net_worth: 68500, currency: "EUR", created_at: ts },
    { id: generateId(), user_id: DEMO_USER_ID, snapshot_date: "2026-05-01", total_assets: 84000, total_liabilities: 12000, net_worth: 72000, currency: "EUR", created_at: ts },
  ];
