...
>[] = [
  { category: "visa",      title: "Research visa requirements",          description: "Check eligibility for your target country's visa program", completed: true,  due_date: null,         priority: "high" },
  { category: "documents", title: "Gather passport & birth certificate", description: "Certified copies may be required",                        completed: true,  due_date: null,         priority: "high" },
  { category: "finance",   title: "Open European bank account",          description: "Research N26, Wise, or local banks in target country",    completed: false, due_date: "2026-06-01", priority: "high" },
  { category: "finance",   title: "Build 6-month emergency fund",        description: "Target ₹15,00,000 minimum for relocation buffer",         completed: false, due_date: "2026-08-01", priority: "medium" },
  { category: "tax",       title: "Consult cross-border tax advisor",    description: "Understand exit tax and EU tax residency rules",          completed: false, due_date: "2026-07-01", priority: "medium" },
  { category: "housing",   title: "Research neighborhoods in target city",description: "Compare rent prices and commute times",                  completed: false, due_date: null,         priority: "low" },
  { category: "healthcare",title: "Get international health insurance quote", description: "Required for many visa applications",                completed: false, due_date: "2026-06-15", priority: "medium" },
  { category: "documents", title: "Apostille degree certificates",       description: "Required for Blue Card and work visas",                  completed: false, due_date: "2026-07-15", priority: "high" },
];
...
export function createDemoData(): AppData {
  ...
  const accounts: Account[] = [
    { id: generateId(), user_id: DEMO_USER_ID, name: "Primary Savings",       type: "checking",   category: "asset",     currency: "INR", balance: 500000,   institution: "HDFC Bank",          notes: "",                           created_at: ts, updated_at: ts },
    { id: generateId(), user_id: DEMO_USER_ID, name: "Emergency Fund",         type: "savings",    category: "asset",     currency: "INR", balance: 1500000,  institution: "SBI",                notes: "",                           created_at: ts, updated_at: ts },
    { id: generateId(), user_id: DEMO_USER_ID, name: "Mutual Funds & Stocks",  type: "investment", category: "asset",     currency: "INR", balance: 3800000,  institution: "Zerodha",            notes: "Nifty50 index + tech stocks", created_at: ts, updated_at: ts },
    { id: generateId(), user_id: DEMO_USER_ID, name: "Crypto Holdings",        type: "crypto",     category: "asset",     currency: "INR", balance: 700000,   institution: "CoinDCX",            notes: "",                           created_at: ts, updated_at: ts },
    { id: generateId(), user_id: DEMO_USER_ID, name: "Education Loan",         type: "other",      category: "liability", currency: "INR", balance: 800000,   institution: "SBI Education Loan", notes: "",                           created_at: ts, updated_at: ts },
  ];
  ...
  const career: CareerGoal = {
    ...
    primaryFocus: "mlops",
    milestones: [
      { id: generateId(), phase: 1, year: 2026, title: "Master Kubernetes + Terraform + AWS",   description: "Become excellent at K8s, Terraform, AWS. Build public projects.", completed: false, dueDate: "2026-12-31" },
      { id: generateId(), phase: 1, year: 2026, title: "Build Production-Grade Projects",       description: "K8s deployment, Prometheus+Grafana, GitOps, autoscaling, CI/CD", completed: false, dueDate: "2026-12-31" },
      { id: generateId(), phase: 2, year: 2027, title: "Switch to Stronger Company",            description: "Target: Datadog, Cloudflare, Grafana Labs, or strong Indian startup", completed: false, dueDate: "2027-06-30" },
      { id: generateId(), phase: 2, year: 2027, title: "Increase Compensation + Global Exposure", description: "Better engineering standards, scale, recognizable brand", completed: false, dueDate: "2027-12-31" },
      { id: generateId(), phase: 3, year: 2028, title: "Apply for Europe Roles",               description: "Target Germany, Netherlands, Ireland. EU Blue Card sponsorship.", completed: false, dueDate: "2028-06-30" },
      { id: generateId(), phase: 3, year: 2028, title: "Relocate to Europe",                   description: "Internal transfer, direct hire, or startup relocation", completed: false, dueDate: "2028-12-31" },
      { id: generateId(), phase: 4, year: 2029, title: "Stabilize Abroad + Build Wealth",      description: "Focus on high-income growth, explore equity opportunities", completed: false, dueDate: "2029-12-31" },
    ],
    skills: [
    ...
    targetCompanies: [
      { id: generateId(), name: "Datadog",    industry: "SaaS / Observability", reason: "Leader in observability, great eng culture, global scale",  difficulty: "hard",   targetPhase: 2, notes: "Strong DevOps/SRE roles. Remote options." },
      { id: generateId(), name: "Cloudflare", industry: "Cloud Infra",          reason: "Edge computing leader, India-friendly, strong culture",     difficulty: "hard",   targetPhase: 2, notes: "Bangalore office. Great for SRE/Platform" },
      { id: generateId(), name: "Grafana Labs",industry: "Observability",       reason: "Open-source friendly, remote-first, excellent culture",     difficulty: "medium", targetPhase: 2, notes: "Very supportive of relocation to EU later" },
      { id: generateId(), name: "HashiCorp",  industry: "Infrastructure",       reason: "Terraform creator. Infra expertise unmatched.",             difficulty: "hard",   targetPhase: 2, notes: "Remote-friendly, strong India presence" },
    ],
    targetCountriesEurope: ["Germany", "Netherlands", "Ireland", "Estonia"],
    completedProjects: ["EdgeVerve DevOps infrastructure", "CI/CD pipeline optimization"],
    inProgressProjects: ["Kubernetes multi-cluster setup", "Prometheus + Grafana monitoring stack", "GitOps with ArgoCD"],
  ...
  const goals: Goal[] = [
    {
      ...
      targetValue: 2000000, currentValue: 1200000, unit: "₹", status: "active", created_at: ts,
    },
    {
      id: generateId(), title: "Get EU Blue Card",
      description: "Secure an EU Blue Card by landing a qualified job offer in Germany.",
      category: "migration", deadline: "2028-06-30",
      milestones: [
      ...
      targetValue: null, currentValue: null, unit: "%", status: "active", created_at: ts,
    },
    {
      id: generateId(), title: "Solve 300 DSA Problems",
      description: "Solve 300 LeetCode problems (mix of easy/medium/hard) to be interview-ready for top companies.",
      category: "career", deadline: "2026-09-30",
      milestones: [
      ...
      targetValue: 300, currentValue: 87, unit: "problems", status: "active", created_at: ts,
    },
    {
      id: generateId(), title: "Master Kubernetes",
      description: "Reach expert level in Kubernetes — from pods to production-grade multi-cluster setups.",
      category: "learning", deadline: "2026-12-31",
      milestones: [
      ...
      targetValue: 100, currentValue: 40, unit: "%", status: "active", created_at: ts,
    },
    {
      id: generateId(), title: "Run 5km Without Stopping",
      description: "Build cardiovascular endurance to run 5km continuously at a steady pace.",
      category: "fitness", deadline: "2026-08-31",
      milestones: [
      ...
      targetValue: 5, currentValue: 2.5, unit: "km", status: "active", created_at: ts,
    },
  ];
  ...
  return { profile, accounts, snapshots, migrationGoal, checklist, career, habits, habitLogs, goals, dailyTasks, studyRoadmap, interviewPrep, journalEntries: [] };
}
